(function(){
  const dict = {
    id: {
      ...
      'event.sample': 'Kajian Akhlak (Online) • Sabtu 19:30 JST',
      ...
      'sch.3': 'Tahfidz & Tahsin — Minggu 08:00 JST',
    ...
    ja: {
      ...
      'hero.b4': '✅ 無料・更新が簡単',
      'event.nearby': '近日イベント',
      'event.sample': '徳目の学び（オンライン）• 土曜 19:30（JST）',
      'sec.tentang': '私たちについて',
      ...
      'sch.3': 'タフフィズ＆タフシーン — 日曜 08:00 JST',
      'sec.artikel': '記事・情報',
      'art.1.t': '学習のコツ',
      'art.1.p': '効果的な学び方',
      'art.2.t': 'モスク案内',
