(function(){
  const dict = {
    id: {
      ...
      'hero.title.pre':'Belajar islam sesuai sunnah ','hero.title.hl':'di Jepang','hero.subtitle':'Platform komunitas Muslim untuk belajar islam sesuai sunnah di Jepang. Terbuka untuk anak-anak dan semua kalangan usia.',
      ...
      'sec.tentang':'Tentang Kami','tentang.p':'Ruang Belajar Muslim (RBM) Jepang adalah lembaga pendidikan nonformal yang berlokasi di Yokohama, sekitar 40 menit hingga 1 jam perjalanan dari Tokyo. RBM Jepang berdiri pada 18 Desember 2022, sebagai respons atas kebutuhan pendidikan agama dan bahasa Arab bagi anak-anak Muslim diaspora yang semakin meningkat di wilayah Yokohama dan sekitarnya. ',
    ...
    ja: {
      ...
      'hero.title.pre':'スンナに沿って学ぶ ','hero.title.hl':'日本で','hero.subtitle':'日本にいるムスリムのための学びのコミュニティ。誰でも参加できます。',
      ...
      'sec.tentang':'私たちについて','tentang.p':'RBMジャパン（Ruang Belajar Muslim Japan）は、神奈川県横浜市に拠点を置く非公式教育機関です。東京から約40分〜1時間の距離に位置しています。2022年12月18日に設立されたRBMジャパンは、横浜および周辺地域に住むムスリムの子どもたちのために、宗教教育とアラビア語教育のニーズの高まりに応える形で誕生しました。
。',
